...
const cardData = [
  {
    ...
    description:
      "Effortlessly integrate and manage data with our cutting-edge API, designed for seamless connectivity.",
    color: "fuchsia",
  },
  {
  ...
  return (
    <section className="py-24 overflow-x-clip md:-mt-28">
      <div className="container">
        ...
        <div className="mt-36 lg:mt-48 flex justify-start">
          <motion.div
            ref={containerRef}
            className="flex flex-none gap-8 cursor-grab active:cursor-grabbing"
            drag="x"
          ...
          >
            {cardData.map(({ image, title, description, color }, cardIndex) => (
              <motion.div
                ...
                animate={{ x: `calc((-100% - 2rem) * ${selectedCardIndex})` }}
                transition={{ type: "spring", stiffness: 300, damping: 30 }}
              >
                <Card className="max-w-xs md:max-w-md group" color={color}>
                  <div className="flex justify-center -mt-28">
                    <div className="inline-flex relative">
                      <div className="absolute h-4 w-full top-[calc(100%+16px)] bg-zinc-950/70 rounded-[100%] [mask-image:radial-gradient(closest-side,black,transparent)] group-hover:bg-zinc-950/50 transition duration-300"></div>
                      <img
                        src={image}
                        alt="Pill Image"
